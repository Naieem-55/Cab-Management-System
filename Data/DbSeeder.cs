        ...
        private static async Task SeedSampleDataAsync(IServiceProvider serviceProvider)
        {
            ...
            var trips = new List<Trip>
            {
                ...
                new Trip
                {
                    ...
                    CustomerEmail = "rahim.uddin@email.com",
                ...
                new Trip
                {
                    ...
                    CustomerEmail = "fatema.begum@email.com",
                ...
                new Trip
                {
                    ...
                    CustomerEmail = "karim.hossain@email.com",
                ...
                new Trip
                {
                    ...
                    CustomerEmail = "nasrin.akter@email.com",
                ...
                new Trip
                {
                    ...
                    CustomerEmail = "jahangir.alam@email.com",
                ...
                new Trip
                {
                    ...
                    VehicleId = savedVehicles[0].Id,
                    RouteId = savedRoutes[0].Id,
                    CustomerName = "Shahana Parvin",
                    CustomerPhone = "9812345006",
                    CustomerEmail = "shahana.parvin@email.com",
